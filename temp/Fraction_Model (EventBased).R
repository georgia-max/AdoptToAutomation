...
write.csv(final_stats,file = "./Event_Based_results/sumstats_043023.csv" )
...
# m1.1= fepois(Error_rate ~ TotalWL + Manual_fraction 
#              +PHONE+JUSTIF_count + MESSAGE_OTHER_count + Hour + TRAF_COMP
#              | DATE_EVENT+ RSE_ID_ANONYM,vcov = "twoway", data = df
# )
# m2.1= fepois(Error_rate ~ TotalWL + Manual_fraction +PHONE+JUSTIF_count + MESSAGE_OTHER_count + Hour+TRAF_COMP+ 
#                Manual_fraction_sq+TotalWL_sq| DATE_EVENT+RSE_ID_ANONYM,vcov = "twoway", data = df
# )



m3.1= fepois(Error_rate ~ TotalWL + Auto_fraction +PHONE+JUSTIF_count + MESSAGE_OTHER_count + Hour+ TRAF_COMP 
               | DATE_EVENT+RSE_ID_ANONYM,vcov = "twoway", data = df
)
m4.1= fepois(Error_rate ~ TotalWL + Auto_fraction +PHONE+JUSTIF_count + MESSAGE_OTHER_count + Hour+ TRAF_COMP + 
               Auto_fraction_sq+TotalWL_sq| DATE_EVENT+RSE_ID_ANONYM,vcov = "twoway", data = df
)

# m5.1= fepois(Error_rate ~ TotalWL + Manual_fraction + TotalWL*Manual_fraction + PHONE+JUSTIF_count + MESSAGE_OTHER_count + Hour+TRAF_COMP+
#                Manual_fraction_sq+TotalWL_sq| DATE_EVENT+RSE_ID_ANONYM,vcov = "twoway", data = df
# )


# m6.1= fenegbin(Error_rate ~ TotalWL + Auto_fraction + TotalWL*Auto_fraction + PHONE+JUSTIF_count + MESSAGE_OTHER_count + Hour+ TRAF_COMP+ 
#                Auto_fraction_sq+TotalWL_sq + Auto_fraction_sq*TotalWL_sq| DATE_EVENT+RSE_ID_ANONYM,vcov = "twoway", data = df
# )

m6.1= fepois(Error_rate ~ TotalWL + Auto_fraction + TotalWL*Auto_fraction + PHONE+JUSTIF_count + MESSAGE_OTHER_count + Hour+ TRAF_COMP+ 
                 Auto_fraction_sq+TotalWL_sq + Auto_fraction_sq*TotalWL_sq| DATE_EVENT+RSE_ID_ANONYM,vcov = "twoway", data = df
)
#Why in m4, Auto_fraction is not significant but ^2 is significant 
etable(m3.1,m4.1, m6.1)
...
# 
# 
# m3= fenegbin(Error_Count ~ TotalWL + Auto_fraction +PHONE+JUSTIF_count + MESSAGE_OTHER_count + Hour+ TRAF_COMP
#              | DATE_EVENT+RSE_ID_ANONYM,vcov = "twoway", data = df
# )
...
# )
# 
# m5= fenegbin(Error_Count ~ TotalWL + Manual_fraction + TotalWL*Manual_fraction + PHONE+JUSTIF_count + MESSAGE_OTHER_count + Hour+TRAF_COMP+
#                Manual_fraction_sq+TotalWL_sq| DATE_EVENT+RSE_ID_ANONYM,vcov = "twoway", data = df
# )
# 
# 
# m6= fenegbin(Error_Count ~ TotalWL + Auto_fraction + TotalWL*Auto_fraction + PHONE+JUSTIF_count + MESSAGE_OTHER_count + Hour+ TRAF_COMP+ 
#                Auto_fraction_sq+TotalWL_sq + Auto_fraction_sq*TotalWL_sq| DATE_EVENT+RSE_ID_ANONYM,vcov = "twoway", data = df
# )
# #Why in m4, Auto_fraction is not significant but ^2 is significant 
...
cap <- 'Automation Usage Table'
#omit<- 'RMSE|BIC'
estimate <- "{estimate} ({std.error}){stars}"
#gof <-  c("nobs", "AIC","logLik")
#gof_map <- c("AIC", "loglik")
note <- list('Signif. Codes: 0 “***” 0.001 “**” 0.01 “*” 0.05 “.” 0 “ “ 1 ')
models<- list("(1) Manual Usage (Linear) "=m1,"(2) Manual Usage (Quadratic) "=m2, "(3) Automation Usage (Linear)"=m3,"(4) Automation Usage(Quadratic)"=m4,
              "(5) Manual Usage (Interaction)" = m5, '(6) Auto Usage (Interaction)' = m6)
...
#library("webshot2")
gt::gtsave(tab,filename = "Auto_Manual_table_all_040623.docx")
...
#gof_map <- c("AIC", "loglik")
note <- list('Signif. Codes: 0 “***” 0.001 “**” 0.01 “*” 0.05 “.” 0 “ “ 1 ')
models<- list( "(1) Linear"=m3,"(2) (Quadratic"=m4, '(3)Interaction' = m6)
...
#library("webshot2")
gt::gtsave(tab,filename = "APM_results/Auto_table_all_043023.docx")
...
#gof_map <- c("AIC", "loglik")
note <- list('Signif. Codes: 0 “***” 0.001 “**” 0.01 “*” 0.05 “.” 0 “ “ 1 ')
models<- list("(1) Automation Usage (Linear)"=m3.1,"(2) Automation Usage(Quadratic)"=m4.1,
