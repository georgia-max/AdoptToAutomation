...
#Ftest is 119.04, with P<0.05, reject the H0 that IV is irrelevant 
...
print(instrFtest)
#Ftest is 379.71, with P<0.05, reject the H0 that IV is irrelevant 
...
########
library("ivreg")
m= ivreg(Error_Count ~   Manual_count + MOVE_AUTO_count+ PHONE + JUSTIF_count + MESSAGE_OTHER_count + Hour 
